            ...
            if ( $login === '' || $this->is_valid_user_name($login) ){
                if ( $this->is_valid_email($email) ){                   
                    ...
                    if($user_row){
                        ...
                        $result_message = $this->external_services->send_recovery_pass
                                            (
                                                $email,
                                                $user_row['login'],
                                                $token,
                            ...
                            if(!$user_row){  
                                ...
                                if(!$user_row){
                                    ...
                                    if($cadastro_id){
                                        ...
                                        $result_message = $this->external_services->send_number_confirm
                                                            (
                                                                $datas['client_email'],
                                                                $datas['client_login'],
                                                                $datas['id_number'],
                        ...
                        if(!$user_row){  
                            ...
                            if($user_row){
                                ...
                                if($cadastro_id){                                    
                                    ...
                                    $result_message = $this->external_services->send_welcome
                                                        (
                                                            $datas['client_email'],
                                                            $datas['client_login'],
                                                            $GLOBALS['language']
        ...
        if ($this->session->userdata('id')){            
            ...
            if($user_row){
                ...
                if($cancelamento){
                    ...
                    $result_message = $this->external_services->send_client_cancel_status
                                        (
...
//        
                ...
                if($num){
                    ...
                    if($resp['success']){
                        ...
                        if($result_insert){                            
                            ...
                            $result_message = $this->external_services->send_client_ticket_success(
                                                                $this->session->userdata('email'),
                                                                $this->session->userdata('login'),
                                                                $datas['ticket_link'],
                                                                $this->session->userdata('language')
    ...
    public function check_mundipagg_credit_card($datas) {
        ...
        if($bandeira)            
            $response = $this->external_services->create_payment($payment_data);        
        else
